...
def main():
 ...
 _______  _______  _        _        _______  ______   _  _______    _______           _______ _________
(       )(  ____ \( \      ( \      (  ___  )(  ___ \ ( )(  ____ \  (  ____ \|\     /|(  ___  )\__   __/
| () () || (    \/| (      | (      | (   ) || (   ) )|/ | (    \/  | (    \/| )   ( || (   ) |   ) (   
| || || || (__    | |      | |      | |   | || (__/ /    | (_____   | |      | (___) || (___) |   | |   
| |(_)| ||  __)   | |      | |      | |   | ||  __ (     (_____  )  | |      |  ___  ||  ___  |   | |   
| |   | || (      | |      | |      | |   | || (  \ \          ) |  | |      | (   ) || (   ) |   | |   
| )   ( || (____/\| (____/\| (____/\| (___) || )___) )   /\____) |  | (____/\| )   ( || )   ( |   | |   
|/     \|(_______/(_______/(_______/(_______)|/ \___/    \_______)  (_______/|/     \||/     \|   )_(   
...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⠙⢿⣤⣤⠴⠟⠋⠉⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⠑⠤⠀⠀⠀⠀⠀⢩⠇⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
~ Crafted by MelloB | Kartik Deshmukh
...
Please enter your username: """)
	...
	while True:
		if state["joinDisconnect"]:
			...
			waitUserInputThread.join()
			waitServerListenThread.join()
			print("Disconnected from MelloB's Chat.")
			break
